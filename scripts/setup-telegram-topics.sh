...
[[ -n "$RESEARCH_TOPIC" ]] && echo "    Research: topic_id=$RESEARCH_TOPIC — use /model gpt-5.5 for deep research"
echo ""
...
echo "  Coding:   /model gpt-5.5 (strong for code — Codex subscription)"
echo "  Research: /model gpt-5.5 (strong reasoning — Codex subscription)"
