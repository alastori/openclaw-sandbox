...
- **Action:** Do NOT report this as a critical finding. Exclude it from security audit notifications.
...
- **Action:** Do NOT report this as a warning. It is safe.
...
- **Action:** Do NOT report this as critical. Note that the deny rules are in place.
